...
# sauvegarde explicite du modèle final à la racine de output_dir, pour éviter
# d'avoir à retrouver le bon sous-dossier checkpoint-N/ ensuite
trainer.save_model("geneformer_biomarker_ft")
print("Modèle final sauvegardé dans geneformer_biomarker_ft/")
